materialAdmin
    ...
    //.controller('ModalFormDialog', ["$rootScope", "$scope", "$filter", "$modal", "dataService", function ($rootScope, $scope, $filter, $modal, dataService) {
    //
    //    //$scope.checkItem = "";
    //
    //    $scope.loadFormDialog = function () {
    //        //$scope.checkItem = "yes";
    //        $modal.open({
    //            templateUrl: '#myModal',
    ...
    //    };
    //}])
    //.controller('ModalFormDialog', [function ($scope, $uibModal, $log) {
    //
    ...
    //
    //    this.loadFormDialogs = function(animation, size, backdrop, keyboard) {
    //        $uibModal.open({
    //            animation: animation,
    //            templateUrl: '#myModal',
    //            controller: 'ModalInstanceCtrl',
