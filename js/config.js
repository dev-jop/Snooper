    ...
    .config(function ($stateProvider, $urlRouterProvider,ParseProvider){
        ...
        $stateProvider
            ...
            .state ('tables.maindash', {
                ...
                url: '/campaigns',
                templateUrl: 'views/campaigns/data-table.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('tables.submissions', {
                url: '/submissions',
                templateUrl: 'views/submissions/data-table.html',
                resolve:{
            ...
            .state ('tables.reviews', {
                url: '/reviews',
                templateUrl: 'views/submissions/reviews.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('tables.missions', {
                url: '/missions',
                templateUrl: 'views/missions/data-table.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
                                ...
                                files: [
                                    ...
                                    'vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
                                    'vendors/bower_components/chosen/chosen.min.css',
                                    'vendors/bower_components/angular-rateit/dist/ng-rateit.css'
                                ]
                            },
                            {
                                name: 'vendors',
                                files: [
                                    ...
                                    'vendors/bower_components/angular-chosen-localytics/chosen.js',
                                    'vendors/bower_components/angular-farbtastic/angular-farbtastic.js',
                                    'vendors/bower_components/angular-rateit/dist/ng-rateit.js'
                                ]
                            }
                        ])
                    }, auth: function resolveAuthentication(AuthResolver) {
            ...
            .state('tables.user', {
                        url: '/user',
                        templateUrl: 'views/user/user-table.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
             ...
             .state('tables.blogpost', {
              ...
              .state('tables.blogs', {
                        url: '/blog',
                        templateUrl: 'views/blogs/data-table.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('tables.checkpoints', {
                url: '/checkpoints',
                templateUrl: 'views/checkpoints/data-table.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
